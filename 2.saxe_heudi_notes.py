...
def infotodict(seqinfo): 
    ...
    t1 = create_key('sub-{subject}/anat/sub-{subject}_T1w') 
        ###creating directory; ex: subject01-> anatomical-> subject01's weighted T1 
